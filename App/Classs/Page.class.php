...
// +----------------------------------------------------------------------
    ...
    class Page
    {
        ...
        private $config = array(
            'header' => '<span class="rows">共 %TOTAL_PAGE% 页 %TOTAL_ROW% 条记录</span>',
            'prev'   => '上一页',
            'next'   => '下一页',
            'first'  => '1...',
            'last'   => '...%TOTAL_PAGE%',
            'theme'  => '<li>%FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END% </li>',
        );
        ...
        public function show()
        {
            ...
            $header = '';
            if ($this->lastSuffix) {
                $header = '<li><span style="background-color:#5e87b0;color:white">' . $this->config['header'] . '</span></li>';
            }
            ...
            for ($i = 1; $i <= $this->rollPage; $i++) {
                ...
                if ($page > 0 && $page != $this->nowPage) {
                    ...
                    if ($page > 0 && $this->totalPages != 1) {
                        $link_page .= '<li><span class="current" style="background-color:#5e87b0;color:white">' . $page . '</span></li>';
                    }
                }
            }
